...
//all new values get by ida
/*
enum camera_ops {
  CAMERA_SET_PARM_DISPLAY_INFO,// 0
  CAMERA_SET_PARM_DIMENSION,// 1
  CAMERA_SET_PARM_ZOOM,// 2
  CAMERA_SET_PARM_ZOOM_VIDEO,// 3
  CAMERA_SET_PARM_SENSOR_POSITION,// 4
  CAMERA_SET_PARM_FOCUS_RECT,// 5
  CAMERA_SET_PARM_LUMA_ADAPTATION,// 6
  CAMERA_SET_PARM_CONTRAST,// 7
  CAMERA_SET_PARM_BRIGHTNESS,// 8
  CAMERA_SET_PARM_EXPOSURE_COMPENSATION,// 9
  CAMERA_SET_PARM_SHARPNESS,// 10
  CAMERA_SET_PARM_HUE,// 11
  CAMERA_SET_PARM_SATURATION,// 12
  CAMERA_SET_PARM_EXPOSURE,// 13
  CAMERA_SET_PARM_AUTO_FOCUS,// 14
  CAMERA_SET_PARM_WB,// 15
  CAMERA_SET_PARM_EFFECT,// 16
  CAMERA_SET_PARM_SCENE_MODE,// 17
  CAMERA_SET_PARM_FPS,// 17
  CAMERA_SET_PARM_FLASH,// 18
  CAMERA_SET_PARM_NIGHTSHOT_MODE,// 19
  CAMERA_SET_PARM_REFLECT,// 20
  CAMERA_SET_PARM_PREVIEW_MODE,// 21
  CAMERA_SET_PARM_ANTIBANDING,// 22
  CAMERA_SET_PARM_RED_EYE_REDUCTION,// 23
  CAMERA_SET_PARM_FOCUS_STEP,// 24
  CAMERA_SET_PARM_EXPOSURE_METERING,// 25
  CAMERA_SET_PARM_AUTO_EXPOSURE_MODE,// 26
  CAMERA_SET_PARM_ISO,// 27
  CAMERA_SET_PARM_BESTSHOT_MODE,// 28
  CAMERA_SET_UNK1,//29
  CAMERA_SET_PARM_PREVIEW_FPS,//30
  CAMERA_SET_PARM_AF_MODE,//31
  CAMERA_SET_PARM_HISTOGRAM,//32,
  CAMERA_SET_PARM_FLASH_STATE,//33,
  CAMERA_SET_PARM_FRAME_TIMESTAMP,//34
  CAMERA_SET_PARM_STROBE_FLASH,// 35
  CAMERA_SET_PARM_FPS_LIST,// 36
  CAMERA_SET_PARM_HJR,//37
  CAMERA_SET_PARM_ROLLOFF,//38
  CAMERA_STOP_PREVIEW,// 39
  CAMERA_START_PREVIEW,//40
  CAMERA_START_SNAPSHOT,//41
  CAMERA_START_RAW_SNAPSHOT,//42
  CAMERA_STOP_SNAPSHOT,//43
  CAMERA_EXIT, //44 look like it be handling somewere else but i find it in ida last time have to be removed!
  CAMERA_GET_PARM_MAXZOOM=48,
  CAMERA_GET_PARM_AF_SHARPNESS=49,
  CAMERA_SET_PARM_LED_MODE=50,
  CAMERA_SET_MOTION_ISO=51,
  CAMERA_AUTO_FOCUS_CANCEL=52,
  CAMERA_GET_PARM_FOCUS_STEP=53,
  CAMERA_ENABLE_AFD=54,
  CAMERA_PREPARE_SNAPSHOT=55,
  CAMERA_SET_FPS_MODE=56,
  CAMERA_START_VIDEO=57,
  CAMERA_STOP_VIDEO=58,
  CAMERA_START_RECORDING=59,
  CAMERA_STOP_RECORDING=60,
  CAMERA_SET_JPEG_QUALITY=62,
};
*/
//old 

enum camera_ops {
   CAMERA_SET_PARM_ENCODE_ROTATION=0, // 0  INAVLID
   CAMERA_SET_PARM_DIMENSION=1,// ida 1(findsensortypeта) 1 OK
   CAMERA_SET_PARM_ZOOM=2, //ida  =  2  OK 
   CAMERA_SET_PARM_SENSOR_POSITION=3, // FIXME UNSUPORTED 3
   CAMERA_SET_PARM_SHARPNESS=10, //UNSUPPORTED 4
   CAMERA_SET_PARM_LUMA_ADAPTATION=5, //UNSUPPORTED 5
   CAMERA_SET_PARM_CONTRAST=7 , // logic 6
   CAMERA_SET_PARM_EXPOSURE_COMPENSATION=7, //7
   CAMERA_SET_PARM_BRIGHTNESS=8, // from ida  //8
   CAMERA_SET_PARM_FOCUS_RECT=9, //9

   CAMERA_SET_PARM_HUE=10, //10
 
  CAMERA_SET_PARM_SATURATION=12,//11
    CAMERA_SET_PARM_EXPOSURE=12,//12 setAutoExposure - unsupported
   CAMERA_UNK1=13, //wingrime fix number allign 13
    CAMERA_SET_PARM_AUTO_FOCUS=14, //14  ida 

    CAMERA_SET_PARM_WB=15,  // ida 15 ???? + // ok
    CAMERA_SET_PARM_EFFECT=16 , // ida 16 ????? +  //ok 
    CAMERA_SET_PARM_FPS=17,  //17 setPreviewFrameRate = not supported
   CAMERA_SET_PARM_FLASH=18,//18
   CAMERA_SET_PARM_NIGHTSHOT_MODE=19,//19
   CAMERA_SET_PARM_REFLECT=20,//20
   CAMERA_SET_PARM_PREVIEW_MODE=21,//21
   CAMERA_SET_PARM_ANTIBANDING=22, //22
   CAMERA_SET_PARM_RED_EYE_REDUCTION=23,//23
   CAMERA_SET_PARM_FOCUS_STEP=24,//24
   CAMERA_SET_PARM_EXPOSURE_METERING=25,//25
   CAMERA_SET_PARM_AUTO_EXPOSURE_MODE=26, //26
   CAMERA_SET_PARM_ISO=27, //27 ida 
   CAMERA_SET_PARM_BESTSHOT_MODE=28, //28 not used in code 
   CAMERA_SET_PARM_PREVIEW_FPS=29,//29
   CAMERA_SET_PARM_AF_MODE=30, //30 not used in code 
   CAMERA_SET_PARAM_FOCUS_MODE=31 ,  //31  ida ok 
   CAMERA_SET_PARM_HISTOGRAM=32,//32
   CAMERA_SET_PARM_FLASH_STATE=33,//33
   CAMERA_SET_PARM_FRAME_TIMESTAMP=34,//34
   CAMERA_SET_PARM_STROBE_FLASH=35,//35
   CAMERA_SET_PARM_FPS_LIST=36,  //36
   CAMERA_SET_PARM_HJR=37, //37 removed 
   CAMERA_SET_PARM_ROLLOFF=38, //38 not suported 
   CAMERA_STOP_PREVIEW=39, //39 ida  stats_rs_enable
   CAMERA_START_PREVIEW=40,//40 ida stats_cs_enable ?
   CAMERA_START_SNAPSHOT=41,//41 ida
   CAMERA_START_RAW_SNAPSHOT=42, //42 ida
   CAMERA_STOP_SNAPSHOT=43, // 43 ida
   CAMERA_EXIT=44, //44 ida
...
private:
    ...
    int native_set_cfg(int cfgtype, int8_t data);
